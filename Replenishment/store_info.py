...
class Replenishment():
    ...
    def __init__(self, store_type_input, transition_date_range, current_year, current_week):
        ...
        self.store_setting = pd.read_excel(rf'C:\Users\User1\OneDrive\WinWin Staff Folders\Michael\Groccery Store Program\{store_type_input}\{store_type_input}_store_setting.xlsm',
                                           sheet_name='Sheet2',
                                           header=None)
    ...
    def sales_import(self, file):
        ...
        ''''This takes in an excel file and inserts delivery data into postgres
         ...
         (transition_date_range, store_year, store_week, store_number,
        ...
        while i < new_len:
            ...
            sales_insert(transition_date_range, store_year, store_week, store_number, upc, sales, qty, current_year,
                         current_week, store_type, self.connection_pool)
            i += 1
